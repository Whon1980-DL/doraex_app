...
urlpatterns = [
    ...
    path('home/', views.home_view, name='home_one'),
    ...
    path('renting_form/edit_renting/<int:renting_id>', views.renting_edit_form, name='renting_edit_form'),
    path('cart/confirm_renting/<int:renting_id>', views.renting_confirm, name='renting_confirm'),
    path('renting_form/confirm_renting/<int:renting_id>', views.renting_confirm, name='renting_confirm'),
    path('renting_form/confirm_renting/confirm_renting/<int:renting_id>', views.renting_confirm, name='renting_confirm'),
    path('cart/delete_renting/<int:renting_id>', views.renting_delete, name='renting_delete'),
    path('renting_form/delete_renting/<int:renting_id>', views.renting_delete, name='renting_delete'),
